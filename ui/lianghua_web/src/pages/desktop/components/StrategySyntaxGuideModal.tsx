...
const SYNTAX_GUIDE_FIELD_SECTIONS: SyntaxGuideFieldSection[] = [
  {
    ...
    fields: [
      ...
      { name: 'TOR', scope: '通用', description: '换手率。', example: 'TOR > 8' },
      { name: 'B_SM_V / S_SM_V', scope: '通用', description: '小单买入量 / 卖出量。', example: 'B_SM_V > S_SM_V' },
      { name: 'B_MD_V / S_MD_V', scope: '通用', description: '中单买入量 / 卖出量。', example: 'B_MD_V > MA(B_MD_V, 5)' },
      { name: 'B_LG_V / S_LG_V', scope: '通用', description: '大单买入量 / 卖出量。', example: 'B_LG_V > S_LG_V' },
      { name: 'B_ELG_V / S_ELG_V', scope: '通用', description: '特大单买入量 / 卖出量。', example: 'B_ELG_V > MA(B_ELG_V, 5)' },
      { name: 'NET_MF_V', scope: '通用', description: '净流入量。', example: 'NET_MF_V > 0' },
    ],
  },
  {
    title: '6. 额外运行时字段',
