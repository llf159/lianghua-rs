...
const menuList = [
  ...
  { path: '/market-monitor', label: '盘中监控' },
]
...
const stockPickSubRoutes = [
  ...
  { path: '/stock-pick/advanced', label: '高级选股' },
]
...
const backtestSubRoutes = [
  ...
  { path: '/backtest/return-analysis', label: '排名回测统计' },
  { path: '/backtest/board-analysis', label: '板块分析' },
  { path: '/backtest/strategy-performance', label: '策略表现回测' },
  { path: '/backtest/strategy-validation', label: '策略验证微调' },
]
