...
export async function getStrategyStatisticsPage(
  query: StrategyStatisticsQuery,
) {
  return invoke<StrategyStatisticsPageData>(
...
export async function getStrategyStatisticsDetail(query: {
  ...
  return invoke<StrategyStatisticsDetailData>(
    "get_strategy_statistics_detail",
    query,
  );
}

export async function getStrategyTriggeredStocks(
  query: StrategyTriggeredStocksQuery,
) {
