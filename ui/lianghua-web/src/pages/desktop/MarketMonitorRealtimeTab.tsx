...
const MARKET_MONITOR_STATE_KEY = "lh_market_monitor_page_state_v2";
...
export default function MarketMonitorRealtimeTab() {
  ...
  return (
    <section className="market-monitor-card">
      <div className="market-monitor-head">
        <div>
          <h2 className="market-monitor-title">实时监控</h2>
          ...
          <table className="market-monitor-table">
            ...
            <thead>
              <tr>
                <th>代码</th>
                <th>名称</th>
                <th aria-sort={getAriaSort(sortKey === "referenceRank", sortDirection)}>
                  <TableSortButton
                    label="参考日排名"
                ...
                <th aria-sort={getAriaSort(sortKey === "totalScore", sortDirection)}>
                  <TableSortButton
                    label="总分"
                ...
                <th aria-sort={getAriaSort(sortKey === "latestChangePct", sortDirection)}>
                  <TableSortButton
                    label="实时涨幅"
                ...
                <th aria-sort={getAriaSort(sortKey === "open", sortDirection)}>
                  <TableSortButton
                    label="开盘"
                  ...
                  <tr key={row.tsCode}>
                    ...
                    <td title={formatPercent(row.latestChangePct)}>
                      <ValueWithDelta
                        ...
                        valueClassName={getPercentClassName(row.latestChangePct)}
                        deltaClassName={getSignedValueClassName(
                    ...
                    <td title={`${formatNumber(row.low)} - ${formatNumber(row.high)}`}>
                      {formatNumber(row.low)} - {formatNumber(row.high)}
                    </td>
                    <td className="market-monitor-cell-concept" title={conceptText}>
                      {conceptText}
                    </td>
                  </tr>
                );
