...
use crate::{
    ...
    ui_tools::{facade::details::DetailKlinePayload, shared::normalize_ts_code},
};
...
fn build_detail_kline_payload(
    ...
    let name_map = crate::ui_tools::shared::build_name_map(source_path).unwrap_or_default();
    let watermark_name = name_map.get(ts_code).cloned();
    let mut payload = crate::ui_tools::facade::details::query_kline(
        &conn,
        source_path,
        ts_code,
