            ...
            if !is_vertical_line && let Some(position) = marker.position {
                lines.push(format!(
                    ...
                    toml_string(match position {
                        crate::indicator::ChartMarkerPosition::Above => "above",
                        crate::indicator::ChartMarkerPosition::Below => "below",
                        crate::indicator::ChartMarkerPosition::Value => "value",
                    })?
                ));
            }
            if !is_vertical_line && let Some(shape) = marker.shape {
                lines.push(format!(
                    ...
                    toml_string(match shape {
                        crate::indicator::ChartMarkerShape::Dot => "dot",
                        crate::indicator::ChartMarkerShape::TriangleUp => "triangle_up",
                        crate::indicator::ChartMarkerShape::TriangleDown => "triangle_down",
                        crate::indicator::ChartMarkerShape::Flag => "flag",
                        crate::indicator::ChartMarkerShape::Square => "square",
                        crate::indicator::ChartMarkerShape::Diamond => "diamond",
                        crate::indicator::ChartMarkerShape::Star => "star",
                    })?
                ));
            }
