...
use lianghua_app_chart::indicator::{
    ChartMarkerKind, ChartMarkerLineStyle, ChartMarkerPosition, ChartMarkerShape, ChartPanelKind,
    ChartPanelRole, ChartSeriesKind, ChartTooltipFormat, CompiledChartIndicatorConfig,
    execute_chart_indicator_config, load_compiled_chart_indicator_config,
};
use lianghua_app_market::realtime::{
    RealtimeFetchMeta, fetch_realtime_quote_map_with_provider, normalize_quote_trade_date,
};
use lianghua_app_shared::{canonical_ts_code, resolve_trade_date};
...
pub struct DetailCyqBin {
    ...
    pub chip: f64,
    pub chip_pct: f64,
    pub main_chip: Option<f64>,
    pub main_chip_pct: Option<f64>,
    pub retail_chip: Option<f64>,
    pub retail_chip_pct: Option<f64>,
    pub total_chip: Option<f64>,
    pub total_chip_pct: Option<f64>,
}
